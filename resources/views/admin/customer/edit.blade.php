...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
        <form method="post" action="{{route('customer.update', $editData->cd_customers)}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-group-prepend">
                    ...
                    <input class="form-control @error('phone_number') is-invalid @enderror" type="text" id="phone_number" name="phone_number" value="{{$editData->phone_number}}" aria-label="">
                    @error('phone_number')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
